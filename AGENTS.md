...
- **Long-term:** `memory/*.md` (按主题分类的长期记忆)
...
**每次需要做一件事时，先检查是否有对应的技能：**

1. 查看 `openclaw skills list` 或使用 `skill-finder-cn` 搜索
2. 如果有匹配的技能，读取其 `SKILL.md` 并按指引执行
3. 只有在没有现成技能的情况下，才自己动手
